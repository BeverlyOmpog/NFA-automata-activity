"""Example 1 DFA Minimization (Board Example 1)
...
class OriginalDFA1:
    """Original 6-State DFA from Board Example 1."""

    def __init__(self):
        self.start_state = "A"
        self.accept_states = {"C", "D", "E"}
        self.transitions = {
            "A": {"0": "B", "1": "C"},
            "B": {"0": "A", "1": "D"},
            "C": {"0": "F", "1": "F"},
...
class MinimizedDFA1:
    """Minimized 3-State DFA from Board Example 1."""

    def __init__(self):
        self.start_state = "AB"
        self.accept_states = {"CDE"}
        self.transitions = {
            "AB": {"0": "AB", "1": "CDE"},
            "CDE": {"0": "CDE", "1": "F"},
            "F": {"0": "F", "1": "F"},
